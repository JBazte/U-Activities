                ...
                <div className='d-flex flex-column h-100'>
                    <div className='mx-4 my-3'>
                        ...
                        <p className='d-flex'>
                            ...
                            <input type="text" name='location' onChange={onChange} className="mb-2 w-100" placeholder='Ubicación' /> <br />
                        </p>
                        <p className='d-flex'>
                            ...
                            <input name='min_members' onChange={onChange} type="number" min={1} className="mb-2 ms-auto me-2" placeholder='Min' style={{ width: "5rem" }} />
                            <input name='max_members' onChange={onChange} id="maxParticipantes" type="number" min={1} className="mb-2" placeholder='Max' style={{ width: "5rem" }} />
                        </p>
